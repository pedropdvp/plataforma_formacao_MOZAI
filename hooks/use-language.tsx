...
const DICTIONARY: Record<Language, Record<string, string>> = {
  ...
  EN: {
    ...
    "nav_content_factory_tools": "Content Generator",
    "nav_coding_lab": "Coding Lab (Practice)",
  ...
  FR: {
    ...
    "nav_content_factory_tools": "Générateur de Contenu",
    "nav_coding_lab": "Coding Lab (Pratique)",
